export const personalLanguageDevelopment = {
  id: "personal-language-development",
  domain: "creative-philosophy",
  subcategory: "Personal Language Development",
  title: "Personal Language Development",

  shortDefinition:
    "Personal Language Development is an essential concept inside the larger jazz language system.",

  longExplanation:
    `Personal Language Development is part of the complete jazz vocabulary. In a teaching context, this topic should not be treated as an isolated definition, but as a musical behavior that connects sound, theory, ear, technique, and performance. The purpose of studying Personal Language Development is to understand how musicians hear, choose, shape, and apply this idea in real musical situations. A complete explanation should connect the concept to harmony, melody, rhythm, voice leading, improvisation, arrangement, and listening whenever relevant.
