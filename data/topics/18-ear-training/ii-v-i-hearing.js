export const iiVIHearing = {
  id: "ii-v-i-hearing",
  domain: "ear-training",
  subcategory: "Ii V I Hearing",
  title: "Ii V I Hearing",

  shortDefinition:
    "Ii V I Hearing is an essential concept inside the larger jazz language system.",

  longExplanation:
    `Ii V I Hearing is part of the complete jazz vocabulary. In a teaching context, this topic should not be treated as an isolated definition, but as a musical behavior that connects sound, theory, ear, technique, and performance. The purpose of studying Ii V I Hearing is to understand how musicians hear, choose, shape, and apply this idea in real musical situations. A complete explanation should connect the concept to harmony, melody, rhythm, voice leading, improvisation, arrangement, and listening whenever relevant.
