export const chordQualityRecognition = {
  id: "chord-quality-recognition",
  domain: "ear-training",
  subcategory: "Chord Quality Recognition",
  title: "Chord Quality Recognition",

  shortDefinition:
    "Chord Quality Recognition is an essential concept inside the larger jazz language system.",

  longExplanation:
    `Chord Quality Recognition is part of the complete jazz vocabulary. In a teaching context, this topic should not be treated as an isolated definition, but as a musical behavior that connects sound, theory, ear, technique, and performance. The purpose of studying Chord Quality Recognition is to understand how musicians hear, choose, shape, and apply this idea in real musical situations. A complete explanation should connect the concept to harmony, melody, rhythm, voice leading, improvisation, arrangement, and listening whenever relevant.
