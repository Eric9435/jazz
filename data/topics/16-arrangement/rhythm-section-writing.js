export const rhythmSectionWriting = {
  id: "rhythm-section-writing",
  domain: "arrangement",
  subcategory: "Rhythm Section Writing",
  title: "Rhythm Section Writing",

  shortDefinition:
    "Rhythm Section Writing is an essential concept inside the larger jazz language system.",

  longExplanation:
    `Rhythm Section Writing is part of the complete jazz vocabulary. In a teaching context, this topic should not be treated as an isolated definition, but as a musical behavior that connects sound, theory, ear, technique, and performance. The purpose of studying Rhythm Section Writing is to understand how musicians hear, choose, shape, and apply this idea in real musical situations. A complete explanation should connect the concept to harmony, melody, rhythm, voice leading, improvisation, arrangement, and listening whenever relevant.
