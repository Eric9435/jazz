export const thirtyTwoBarSongForm = {
  id: "thirty-two-bar-song-form",
  domain: "form",
  subcategory: "Thirty Two Bar Song Form",
  title: "Thirty Two Bar Song Form",

  shortDefinition:
    "Thirty Two Bar Song Form is an essential concept inside the larger jazz language system.",

  longExplanation:
    `Thirty Two Bar Song Form is part of the complete jazz vocabulary. In a teaching context, this topic should not be treated as an isolated definition, but as a musical behavior that connects sound, theory, ear, technique, and performance. The purpose of studying Thirty Two Bar Song Form is to understand how musicians hear, choose, shape, and apply this idea in real musical situations. A complete explanation should connect the concept to harmony, melody, rhythm, voice leading, improvisation, arrangement, and listening whenever relevant.
