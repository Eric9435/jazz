export const spreadVoicings = {
  id: "spread-voicings",
  domain: "voicing",
  subcategory: "Spread Voicings",
  title: "Spread Voicings",

  shortDefinition:
    "Spread Voicings is an essential concept inside the larger jazz language system.",

  longExplanation:
    `Spread Voicings is part of the complete jazz vocabulary. In a teaching context, this topic should not be treated as an isolated definition, but as a musical behavior that connects sound, theory, ear, technique, and performance. The purpose of studying Spread Voicings is to understand how musicians hear, choose, shape, and apply this idea in real musical situations. A complete explanation should connect the concept to harmony, melody, rhythm, voice leading, improvisation, arrangement, and listening whenever relevant.
