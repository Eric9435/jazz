export const herbieHancockModernHarmony = {
  id: "herbie-hancock-modern-harmony",
  domain: "piano-language",
  subcategory: "Herbie Hancock Modern Harmony",
  title: "Herbie Hancock Modern Harmony",

  shortDefinition:
    "Herbie Hancock Modern Harmony is an essential concept inside the larger jazz language system.",

  longExplanation:
    `Herbie Hancock Modern Harmony is part of the complete jazz vocabulary. In a teaching context, this topic should not be treated as an isolated definition, but as a musical behavior that connects sound, theory, ear, technique, and performance. The purpose of studying Herbie Hancock Modern Harmony is to understand how musicians hear, choose, shape, and apply this idea in real musical situations. A complete explanation should connect the concept to harmony, melody, rhythm, voice leading, improvisation, arrangement, and listening whenever relevant.
