export const twoHandComping = {
  id: "two-hand-comping",
  domain: "comping",
  subcategory: "Two Hand Comping",
  title: "Two Hand Comping",

  shortDefinition:
    "Two Hand Comping is an essential concept inside the larger jazz language system.",

  longExplanation:
    `Two Hand Comping is part of the complete jazz vocabulary. In a teaching context, this topic should not be treated as an isolated definition, but as a musical behavior that connects sound, theory, ear, technique, and performance. The purpose of studying Two Hand Comping is to understand how musicians hear, choose, shape, and apply this idea in real musical situations. A complete explanation should connect the concept to harmony, melody, rhythm, voice leading, improvisation, arrangement, and listening whenever relevant.
